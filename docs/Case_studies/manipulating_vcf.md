...
Find the GFF3 [here](https://ftp.ensembl.org/pub/release-101/gff3/drosophila_melanogaster/ "Drosophila_melanogaster.BDGP6.28.101.chr.gff3").

### The genome sequence used in this project:
The genome is located [here](https://ftp.ensemblgenomes.org/pub/metazoa/release-48/fasta/drosophila_melanogaster/dna "Drosophila_melanogaster.BDGP6.28.dna.toplevel.fa").
